...
function handleBrowserAppRequest(clientDistPath, req, res) {
...
function createApp(options = {}) {
  ...
  const clientDistPath =
    options.clientDistPath || path.join(__dirname, "..", "client", "dist");
  const shouldInitializeDatabase = options.initializeDatabase !== false;
  ...
  app.get("*", (req, res) => {
    return handleBrowserAppRequest(clientDistPath, req, res);
  });
...
module.exports = { createApp, handleBrowserAppRequest };
